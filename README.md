# WeatherControl — Панель управления игровыми серверами

**WeatherControl** — это веб-приложение для администрирования параметров погоды на игровых серверах. Администратор может вручную или автоматически изменять температуру, тип погоды, ветер и влажность, а также просматривать историю изменений. Игроки могут просматривать актуальную информацию в упрощённом интерфейсе без элементов управления.
